## To cache the inverse of a matrix insted of computing it repeatedly,
...
## If yes, it gives the result and skips the computation. 
## If no, it computes the inv and sets value incache via setinverse function.
